...
function Disorder(sim_params::SimParams)
  ...
  Disorder(chemical_potential, chemical_weight, bond_disorder_villain, bond_disorder_loop, weights_inc, weights_dec, sum_villain_bond, sum_loop_bond, sum_loop_bond_inverse)
end
